...
export default function HomeProducts({ onShowDetails }: HomeProductsProps) {
    ...
    return (
        ...
        >
                <h1 className="text-center text-lg md:text-3xl font-hammersmith font-medium">PRODUCTOS DESTACADOS</h1>
                <a href="/lista-productos" className='w-max'>
                    <span className='text-sm md:text-base font-hammersmith cursor-pointer hover:text-violet-700'>{`Más productos >`}</span>
                </a>
